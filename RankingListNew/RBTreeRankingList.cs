...
内存占用: 21.55 MB
内存峰值: 25.34 MB
测试日期: 2026/3/8 22:29:46
√ 所有操作结果验证通过！
总耗时: 24 ms vs 23 ms (+4.35%)
平均耗时: 0.24 ms/1k操作 vs 0.23 ms/1k操作 (+4.35%)
内存占用: 21.55 MB vs 9.30 MB (+131.76%)
内存峰值: 25.34 MB vs 13.05 MB (+94.20%)
...
测试日期: 2026/3/8 22:29:46
√ 所有操作结果验证通过！
总耗时: 100 ms vs 52 ms (+92.31%)
平均耗时: 1.00 ms/1k操作 vs 0.52 ms/1k操作 (+92.31%)
...
内存占用: 80.88 MB
内存峰值: 84.26 MB
测试日期: 2026/3/8 22:29:48
√ 所有操作结果验证通过！
总耗时: 63 ms vs 26 ms (+142.31%)
平均耗时: 0.63 ms/1k操作 vs 0.26 ms/1k操作 (+142.31%)
内存占用: 80.88 MB vs 80.88 MB (0.00%)
内存峰值: 84.26 MB vs 80.96 MB (+4.08%)
...
内存占用: 2.29 MB
内存峰值: 2.30 MB
测试日期: 2026/3/8 22:29:51
√ 所有操作结果验证通过！
总耗时: 33 ms vs 27 ms (+22.22%)
平均耗时: 0.33 ms/1k操作 vs 0.27 ms/1k操作 (+22.22%)
...
测试日期: 2026/3/8 22:29:51
√ 所有操作结果验证通过！
总耗时: 83 ms vs 59 ms (+40.68%)
平均耗时: 0.83 ms/1k操作 vs 0.59 ms/1k操作 (+40.68%)
...
内存占用: 263.91 MB
内存峰值: 275.40 MB
测试日期: 2026/3/8 22:29:54
√ 所有操作结果验证通过！
总耗时: 1433 ms vs 544 ms (+163.42%)
平均耗时: 1.43 ms/1k操作 vs 0.54 ms/1k操作 (+163.42%)
...
内存占用: 30.36 MB
内存峰值: 36.96 MB
测试日期: 2026/3/8 22:30:01
√ 所有操作结果验证通过！
总耗时: 46 ms vs 23 ms (+100.00%)
平均耗时: 0.46 ms/1k操作 vs 0.23 ms/1k操作 (+100.00%)
内存占用: 30.36 MB vs 29.07 MB (+4.42%)
内存峰值: 36.96 MB vs 32.83 MB (+12.58%)
== Test t10w_10w End ===
*/