...
{
    public class BlockSkipListRankingList3 : IRankingList
    {
        ...
        public BlockSkipListRankingList3(Span<User> users)
        {
            users.Sort();
        ...
        public BlockSkipListRankingList3(List<User> users) :
        ...
        class SkipList
        {
            ...
            public void RemoveUser(User user)
            {
                ...
                if (userIndexInBlock == 0)
                {
                    current.MinUser = userBlock.MinUser;
                }
        ...
        class SkipListNode
        {
            ...
            // 优化内存局部性，冗余存储每个节点的最小用户，避免访问UserBlock时的指针跳转
            public User MinUser;
...
// 内存集中申请以后，性能有所提升
/*
测试类: BlockSkipListRankingList3
基准测试类: BlockSkipListRankingList2
== Test t1w_100w ===
用户数: 10000
操作数: 1000000
排行榜用户数: 110059
