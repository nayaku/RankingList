...
{
    public class BucketSkipListRankingList2 : IRankingList
    {
        ...
        public BucketSkipListRankingList2(Span<User> users)
        {
            users.Sort();
        ...
        public BucketSkipListRankingList2(List<User> users) :
...
测试类: BucketSkipListRankingList2
== Test t1w_100w ===
用户数: 10000
操作数: 1000000
排行榜用户数: 110059
