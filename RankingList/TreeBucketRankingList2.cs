...
内存占用: 705.85 MB
内存峰值: 706.90 MB
测试日期: 2026/1/26 17:35:26

=== 与基准 BucketRankingList 的对比 ===
总耗时: 1766 ms vs 3122 ms (-43.43%)
平均耗时: 1.77 ms/1000操作 vs 3.12 ms/1000操作 (-43.43%)
内存占用: 705.85 MB vs 707.04 MB (-0.17%)
内存峰值: 706.90 MB vs 707.04 MB (-0.02%)

=== 单项操作耗时测试 ===

【AddUser】
  操作数: 100000 vs 100000
  总耗时: 65 ms vs 190 ms (-65.79%) (100000次操作)
  平均耗时: 0.65 ms/1000操作 vs 1.90 ms/1000操作 (-65.79%)
【UpdateUser】
  操作数: 200000 vs 200000
  总耗时: 365 ms vs 2874 ms (-87.30%) (200000次操作)
  平均耗时: 1.83 ms/1000操作 vs 14.37 ms/1000操作 (-87.30%)
【GetUserRank】
...
【GetTopN】
  操作数: 200000 vs 200000
  总耗时: 475 ms vs 608 ms (-21.88%) (200000次操作)
  平均耗时: 2.38 ms/1000操作 vs 3.04 ms/1000操作 (-21.88%)
【GetAroundUser】
  操作数: 200000 vs 200000
  总耗时: 296 ms vs 1765 ms (-83.23%) (200000次操作)
  平均耗时: 1.48 ms/1000操作 vs 8.83 ms/1000操作 (-83.23%)
*/