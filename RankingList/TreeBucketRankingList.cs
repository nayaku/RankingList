...
内存占用: 711.35 MB
内存峰值: 710.41 MB
测试日期: 2026/1/26 17:36:55

=== 与基准 BucketRankingList 的对比 ===
总耗时: 1731 ms vs 3122 ms (-44.55%)
平均耗时: 1.73 ms/1000操作 vs 3.12 ms/1000操作 (-44.55%)
内存占用: 711.35 MB vs 707.04 MB (+0.61%)
内存峰值: 710.41 MB vs 707.04 MB (+0.48%)
...
【UpdateUser】
  ...
  总耗时: 361 ms vs 2874 ms (-87.44%) (200000次操作)
  平均耗时: 1.81 ms/1000操作 vs 14.37 ms/1000操作 (-87.44%)
【GetUserRank】
...
【GetTopN】
  操作数: 200000 vs 200000
  总耗时: 466 ms vs 608 ms (-23.36%) (200000次操作)
  平均耗时: 2.33 ms/1000操作 vs 3.04 ms/1000操作 (-23.36%)
【GetAroundUser】
  操作数: 200000 vs 200000
  总耗时: 293 ms vs 1765 ms (-83.40%) (200000次操作)
  平均耗时: 1.47 ms/1000操作 vs 8.83 ms/1000操作 (-83.40%)
*/