...
{
    public class TreeAVLBucketRankingList : IRankingList
    {
        ...
        public TreeAVLBucketRankingList(IUser[] users)
        {
            Array.Sort(users);
...
=== 测试 TreeAVLBucketRankingList 排行榜 ===
初始用户数: 10000
操作数: 1000000

=== 验证操作结果与基准对比 ===
√ 所有操作结果验证通过！
测试操作结果已保存到 TreeAVLBucketRankingList_test_results.json

=== 测试结果 ===
排行榜名称: TreeAVLBucketRankingList
总耗时: 1832 ms
平均耗时: 1.83 ms/1000操作
内存占用: 711.89 MB
内存峰值: 712.83 MB
测试日期: 2026/1/27 11:41:50

=== 与基准 BucketRankingList 的对比 ===
总耗时: 1832 ms vs 3122 ms (-41.32%)
平均耗时: 1.83 ms/1000操作 vs 3.12 ms/1000操作 (-41.32%)
内存占用: 711.89 MB vs 707.04 MB (+0.69%)
内存峰值: 712.83 MB vs 707.04 MB (+0.82%)

=== 单项操作耗时测试 ===

【AddUser】
  操作数: 100000 vs 100000
  总耗时: 66 ms vs 190 ms (-65.26%) (100000次操作)
  平均耗时: 0.66 ms/1000操作 vs 1.90 ms/1000操作 (-65.26%)
【UpdateUser】
  操作数: 200000 vs 200000
  总耗时: 339 ms vs 2874 ms (-88.20%) (200000次操作)
  平均耗时: 1.70 ms/1000操作 vs 14.37 ms/1000操作 (-88.20%)
【GetUserRank】
  操作数: 300000 vs 300000
  总耗时: 263 ms vs 2313 ms (-88.63%) (300000次操作)
  平均耗时: 0.88 ms/1000操作 vs 7.71 ms/1000操作 (-88.63%)
【GetTopN】
  操作数: 200000 vs 200000
  总耗时: 454 ms vs 608 ms (-25.33%) (200000次操作)
  平均耗时: 2.27 ms/1000操作 vs 3.04 ms/1000操作 (-25.33%)
【GetAroundUser】
  操作数: 200000 vs 200000
  总耗时: 294 ms vs 1765 ms (-83.34%) (200000次操作)
  平均耗时: 1.47 ms/1000操作 vs 8.83 ms/1000操作 (-83.34%)
*/
// 没啥区别